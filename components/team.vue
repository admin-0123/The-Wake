<template>
  <div id="team">
    <div class="text-center pt-16 pb-12 mx-0 sm:mx-48">
      ...
      <img src="~/assets/image/section_line.png" alt="Line" class="m-auto my-2" />
      
      <div class="grid grid-cols-12 sm:grid-cols-10 gap-x-4  sm:gap-y-0 mx-4 sm:mx-28 my-10 gibson">
        <a href="https://www.linkedin.com/in/samet-pala-a55966222/" target="_blank" class="col-span-4 sm:col-span-2">
          <div class="px-4 sm:px-4 py-3">
            <div class="photo-wrapper">
              <img src="~/assets/image/team/team1.jpg" class="w-full h-full" alt="" />
            </div>
            <p class="text-lg text-center gibsonsemibold mt-4">
              SAMET PALA<font-awesome-icon icon="fab fa-linkedin-in"
                class="mx-2 bg-sky-600 text-white relative text-base rounded p-1" />
            </p>
        ...
        <a href="https://www.linkedin.com/in/samet-pala-a55966222/" target="_blank" class="col-span-4 sm:col-span-2">
          <div class="px-4 sm:px-4 py-3">
            ...
            <p class="text-lg">Game Dev Lead</p>
          </div>
        </a>
        ...
        <a href="https://www.linkedin.com/in/samet-pala-a55966222/" target="_blank" class="col-span-4 sm:col-span-2">
          <div class="px-4 sm:px-4 py-3">
            ...
            <p class="text-lg">2D Art Artist</p>
          </div>
        </a>
        ...
        <a href="https://www.linkedin.com/in/samet-pala-a55966222/" target="_blank" class="col-span-4 sm:col-span-2">
          <div class="px-4 sm:px-4 py-3">
            ...
            <p class="text-lg">Game Operation</p>
          </div>
        </a>
        ...
        <a href="https://www.linkedin.com/in/samet-pala-a55966222/" target="_blank" class="col-span-4 sm:col-span-2">
          <div class="px-4 sm:px-4 py-3">
            ...
            <p class="text-lg">Blockchain Dev</p>
          </div>
        </a>
        ...
        <a href="https://www.linkedin.com/in/samet-pala-a55966222/" target="_blank" class="col-span-4 sm:col-span-2">
          <div class="px-4 sm:px-4 py-3">
            ...
            <p class="text-lg text-center gibsonsemibold mt-4">
              AHMAD AMAN<font-awesome-icon icon="fab fa-linkedin-in"
                class="mx-2 bg-sky-600 text-white relative text-base rounded p-1" />
            </p>
            <p class="text-lg">Partnership Manager</p>
          </div>
        </a>
