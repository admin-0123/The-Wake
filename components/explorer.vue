<template>
  <div id="explorer">
    <div class="grid grid-cols-1 sm:grid-cols-2 pt-20">
      <div class="explorer-left mx-10 sm:mx-20">
        <div class="image-wrapper_temp w-full sm:w-9/12">
          <img
        ...
        <p class="text-gray-600">
          ...
          and freezing cold screamed Niflheim, but he unconsciously struggled to
          lift his trembling body. Countless adventures and 9 realms to learn
